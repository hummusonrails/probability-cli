...
If you find a bug, have a question, or want to request a new feature, please [create an issue](https://github.com/hummusonrails/probability-cli/issues/new) in the project repository. When reporting a bug, please include:
...
7. Create a [pull request](https://github.com/hummusonrails/probability-cli/compare) to the main repository.
...
If you have questions or need help with contributing, please [create an issue](https://github.com/hummusonrails/probability-cli/issues/new) or reach out to the project maintainers through the preferred communication channels.
